...
All collections now use the same database for optimal performance.
"""
...
# Cross-service collections access (all now in same database)
...
db = db_manager.get_database("main")  # All services use main database now
auth_db = db_manager.get_database("main")  # Same as main
club_db = db_manager.get_database("main")  # Same as main

# Additional collections (all in same database now)
locker_room_logs_collection = collections.get_locker_room_logs_collection()
moderator_requests_collection = collections.get_moderator_requests_collection()
moderator_audit_logs_collection = collections.get_moderator_audit_logs_collection()
subscription_plans_collection = collections.get_subscription_plans_collection()
subscriptions_collection = collections.get_subscriptions_collection()
subscription_analytics_collection = collections.get_subscription_analytics_collection()
subscription_admin_logs_collection = collections.get_subscription_admin_logs_collection()
inclusions_collection = collections.get_inclusions_collection()
sports_collection = collections.get_sports_collection()
